...
public class ChatroomAlpha implements Runnable {
    ...
    public void run() {
        ...
        try (ServerSocket serverSocket = new ServerSocket(portNumber)) {
            ...
            System.out.println("Alpha Server Running on (4000)...");
            while (true) {
                ...
                client.start();
                System.out.println("Thread Name: " + client.getName() + " connected... (4000)");
    ...
    void checkOnNetwork() {
        try {
            System.out.println("--------------------------------------");
            System.out.println("ALPHA SERVER REPORT (PORT 4000)");
    ...
    public class Echoer extends Thread {
        ...
        public void run() {
            try {
                ...
                boardCast(userName + " has joined the chatroom! (4000)");
                ...
                while (true & echoString != null) {
                    ...
                    output.println(">>>");
                    boardCast(Thread.currentThread().getName() + "(PORT 4000) : " + echoString);
                ...
                System.out.println(Thread.currentThread().getName() + " : Has left the chatroom (4000)");
                boardCast(Thread.currentThread().getName() + " : Has left the chatroom (4000)");
